...
execute unless score .hide_msg wasd matches 1.. run tellraw @a [{"text":"WASD Detection Installed "},{"text":"[Hide reload message]","color":"gray","clickEvent": { "action": "run_command","value": "/scoreboard players set .hide_msg wasd 1"}}]